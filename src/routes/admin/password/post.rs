...
pub async fn change_password(form: web::Form<FormData>, session: TypedSession, pool: web::Data<Pool<ConnectionManager<PgConnection>>>) -> Result<HttpResponse, actix_web::Error> {
